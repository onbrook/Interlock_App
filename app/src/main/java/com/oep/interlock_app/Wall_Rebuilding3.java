    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = null;
                if(position==0){
                    intent = new Intent(Wall_Rebuilding3.this, AboutPage.class);
                }
                else if(position==1){
                    intent = new Intent(Wall_Rebuilding3.this, HelpPage.class);
                }
                else if(position==2){
                    intent = new Intent(Wall_Rebuilding3.this, HomeScreen.class);
                }
                else if(position==3){
                    intent = new Intent(Wall_Rebuilding3.this, EstimationPage.class);
                }
                else if(position==4){
                    intent = new Intent(Wall_Rebuilding3.this, DatabaseManagement.class);
                }
                else if(position==5){
                    intent = new Intent(Wall_Rebuilding3.this, EnterDatabaseIdActivity.class);
                }
                else if(position==6){//this will only be true if the user is owner
                    intent = new Intent(Wall_Rebuilding3.this, ActivityDatabaseAccounts.class);
                }
