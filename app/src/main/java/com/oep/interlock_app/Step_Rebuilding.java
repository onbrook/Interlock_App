    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position==0){
                    startActivity(new Intent(Step_Rebuilding.this, AboutPage.class));
                }
                else if(position==1){
                    startActivity(new Intent(Step_Rebuilding.this, HelpPage.class));
                }
                else if(position==2){
                    startActivity(new Intent(Step_Rebuilding.this, HomeScreen.class));
                }
                else if(position==3){
                    startActivity(new Intent(Step_Rebuilding.this, EstimationPage.class));
                }
                else if(position==4){
                    startActivity(new Intent(Step_Rebuilding.this, DatabaseManagement.class));
                }
                else if(position==5){
                    startActivity(new Intent(Step_Rebuilding.this, EnterDatabaseIdActivity.class));
                }
                else if(position==6){//this will only be true if the user is owner
                    startActivity(new Intent(Step_Rebuilding.this, ActivityDatabaseAccounts.class));
                }
            }
        });
    }
